...
- selekcja: wybór rodziców **µ(75)** (typ selekcji: proporcjonalna do przystosowania) -> losowo wybieramy pary do krzyżowania -> tworzymy **λ(75)** potomków -> ze zbioru **µ**+**λ** wybieramy **a** osobników do nowej populacji (typ selekcji: proporcjonalna do przystosowania)
